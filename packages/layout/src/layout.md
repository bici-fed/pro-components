...
```js | pure
import { getMenuData } from '@bicitech-design/pro-components';
...
```ts | pure
// 可以通过 import { Settings } from '@bicitech-design/pro-layout/defaultSettings'
// 来获取这个类型
...
```ts | pure
// 可以通过 import { MenuDataItem } from '@bicitech-design/pro-components'
// 来获取这个类型
...
```ts | pure
// 可以通过 import { RouterTypes } from '@bicitech-design/pro-layout/lib/typings';
// 来获取这个类型
